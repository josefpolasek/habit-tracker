    ...
    <TableWrapper>
      <Table>
        ...
        <tbody>
          {data.map((row) => (
            <TR key={row.id}>
              <TDay onClick={() => console.log(row.id)}>
                <DateContainer>
              ...
              <TD>
                <button
                  style={{ backgroundColor: COLORS[row.alcohol] }}
                  onClick={() => {
                    const newData = [...data];
                    newData[row.id].alcohol = (data[row.id].alcohol + 1) % 3;
                    setData(newData);
                  }}
                />
              </TD>
              ...
              <TD>
                <button
                  style={{ backgroundColor: COLORS[row.meditation] }}
                  onClick={() => {
                    const newData = [...data];
                    newData[row.id].meditation = (data[row.id].meditation + 1) % 3;
                    setData(newData);
                  }}
                />
              </TD>
              ...
              <TD>
                <button
                  style={{ backgroundColor: COLORS[row.sport] }}
                  onClick={() => {
                    const newData = [...data];
                    newData[row.id].sport = (data[row.id].sport + 1) % 3;
                    setData(newData);
                  }}
                />
              </TD>
              ...
              <TD>
                <button
                  style={{ backgroundColor: COLORS[row.habit1] }}
                  onClick={() => {
                    const newData = [...data];
                    newData[row.id].habit1 = (data[row.id].habit1 + 1) % 3;
                    setData(newData);
                  }}
                />
              </TD>
              ...
              <TD>
                <button
                  style={{ backgroundColor: COLORS[row.habit2] }}
                  onClick={() => {
                    const newData = [...data];
                    newData[row.id].habit2 = (data[row.id].habit2 + 1) % 3;
                    setData(newData);
                  }}
                />
              </TD>
              ...
              <TD>
                <button
                  style={{ backgroundColor: COLORS[row.habit3] }}
                  onClick={() => {
                    const newData = [...data];
                    newData[row.id].habit3 = (data[row.id].habit3 + 1) % 3;
                    setData(newData);
                  }}
                />
              </TD>
